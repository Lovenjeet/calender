...
div.topLine {margin:0 20px; line-height:30px;}
div.navBar {clear:both; padding:0px 10px; line-height:20px; background:".BGND3."; border:".BORD1.";}
div.content {clear:both; position:absolute; left:0; top:48px; right:0; bottom:35px; clear:both; padding:3px 26px 0 10px;}
...
.barHead {background:".BGND3."; margin-top:2px; cursor:move;}
"
.// ---- all pages -----
"
.scroll {overflow:auto;}
.scrollBoxYe {position:absolute; left:0; top:20px; right:0; bottom:0px; padding:0 10px; overflow:auto;}
.scrollBoxMo, .scrollBoxWe, .scrollBoxDa {position:absolute; left:0; top:35px; right:0; bottom:0px; padding:0 10px; overflow-y:scroll;}
.scrollBoxUp, .scrollBoxCh {position:absolute; left:0; top:75px; right:0; bottom:0px; padding:0 10px; overflow:auto;}
.scrollBoxSh, .scrollBoxSe, .scrollBoxAd {position:absolute; left:0; top:135px; right:0; bottom:0px; padding:0 10px; overflow:auto;}
.scrollBoxHead {position:absolute; left:0; top:19px; right:0; padding:0 10px; overflow-y:scroll;}
...
div.apdLine {text-align:center; margin: 4px 0; font-weight:bold;}
...
"
#htmlPop {position:absolute; width:150px; font:".FONT5."; padding:4px; ".($boxRc ? 'border-radius:5px; ' : '').($boxSw ? 'box-shadow:5px 5px 5px #888; ' : '')."visibility:hidden; z-index:10;}
.normal {".POPDT."}
.private {".POPPT."}
.repeat {".POPRT."}
"
