...
CALSCALE:GREGORIAN\r\n";
	...
	$fromD = date("Y-m-d", mktime(12,0,0) - 86400*365*5); //-5 years
	$sRange = $fromD ? $fromD : date('Y-m-d',mktime(12,0,0) - 86400*7);; //default: -1 week
	...
	//save to iCal file
	$fileName = "./files/".str_replace(' ','_',$set['calendarTitle']).".ics";
	file_put_contents($fileName, $icsHead.$icsBody.$icsTail, LOCK_EX);
	return $nrExported;
}
?>
