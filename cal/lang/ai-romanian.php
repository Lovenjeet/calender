...
"minutes" => "minute",
"pixels" => "pixeli",
"no_way" => "Nu aveți drepturi de a executa această operațiune",
...
"calendarEmail_label" => "Adresa de email calendar",
...
"backLinkUrl_text" => "URL-ul paginii părinte. Dacă acesta este specificat, suplimentar, în partea stîngă a barei de navigare, va fi afișat un buton <b>Înapoi</b>  care va permite întoarcerea la pagina părinte. Spre exemplu, acest buton va permite revenirea la pagina de unde a fost lansat calendarul.",
"timeZone_label" => "Fus orar",
"timeZone_text" => "Fusul orar al calendarului, folosit pentru afișarea orei curente exacte.",
"see" => "vezi",
...
"details4All_label" => "Afișare detalii evenimente pentru toți utilizatorii",
"details4All_text" => "<b>Activ</b>: detalile evenimentului sînt vizibile pentru toți utilizatorii.<br><b>Inactiv</b>: detaliile evenimentului vor fi vizibile doar pentru proprietar și pentru utilizatorii care au dreptul \'toate evenimentele\' activat. Utilizatorii cu drepturi restrînse nu vor putea vedea aceste detaliile.",
...
"navButText_label" => "Buton de navigare cu text",
"navButText_text" => "<b>Activ</b>: Butonul va fi afișat în bara de navigare doar cu text.<br><b>Inactiv</b>: butonul va fi afișat doar cu simbol (icon).",
"navTodoList_label" => "Butonul 'De văzut' în bara de navigare",
"navTodoList_text" => "<b>Activ</b>: Butonul \'De văzut\' va fi afișat în bara de navigare, fiind folosit pentru afișarea listei evenimentelor de văzut.",
"navUpcoList_label" => "Butonul 'Care urmează'",
"navUpcoList_text" => "<b>Activ</b>: Butonul \'Care urmează\ va fi afișat în bara de navigare, fiind folosit pentru afișarea listei evenimentelor viitoare.",
...
"userMenu_text" => "Afișare meniu filtrare utilizatori în bara de navigare.<br>Acest meniu poate fi utilizat pentru filtrarea evenimentelor corespunzătoare utilizatorului selectat.",
"catMenu_label" => "Meniu filtrare categorie",
"catMenu_text" => "Afișare meniu filtrare categorie în bara de navigare.<br>Acest meniu poate fi utilizat pentru filtrarea categoriei selectate.",
"langMenu_label" => "Meniu selecție limbă",
"langMenu_text" => "Afișare opțiune selecție limbă în bara de navigare.<br>Această opțiune poate fi utilizată pentru selectarea limbii de afișare a calendarului.<br>(util doar dacă se utilizează mai multe limbi)",
"defaultView_label" => "Mod vizualizare inițial",
"defaultView_text" => "Modul de vizualizare implicit la pornire poate fi selectat dintre următoarele moduri:<br>- Anual<br>- Lunar<br>- Săptămînal<br>- Zilnic<br>- Care urmează<br>- Modificări<br>Se recomandă utilizarea modului \'Lunar\' sau \'Care urmează\'.",
...
"miniCalHBox_label" => "Detalii minicalendar la plasarea mausului deasupra",
"miniCalHBox_text" => "Dacă se activează această opțiune, la plasarea indicatorului mausului deasupra minicalendarului, va fi afișată automat o mini-fereastră deasupra cu detalii legate de evenimentele din minicalendar",
...
"sideBarHBox_label" => "Detalii zonă laterală la plasare indicatorului mausului desupra",
"sideBarHBox_text" => "Dacă se activează această opțiunea, la plasarea indicatorului mausului deasupra zonei laterale de afișare, va fi afișată o mini-fereastră cu detalii despre evenimente afișate aici (zona de afișare laterală).",
...
"eventHBox_label" => "Detalii evenimente la plasarea indicatorului mausului",
"eventHBox_text" => "Dacă această opțiune este activă, la poziționarea indicatorului mausului peste un eveniment, va fi afișată în mod automat o mini-fereastră cu detalii despre eveniment.",
"showAdEd_label" => "Afișare dată adăugare/modificare eveniment",
"showAdEd_text" => "Afișează data la care un eveniment a fost adăugat sau modificat precum și utilizatorul care a efectuat aceste operațiuni în:<br>- modul de vizualizare \'Care Urmează\'<br>- modul de vizualizare \'Modificări\'<br>- evenimentele din pagina \'Căutare text\'<br>- flux RSS<br>- notificările prin email.",
"showCatName_label" => "Afișare denumire categorie",
"showCatName_text" => "Daca opțiunea este activă, în diferite moduri de vizualizare, pe lîngă afișarea evenimentului în culoarea categoriei selectate va fi afișat și denumirea categoriei.",
...
"eventColor_label" => "Culorile folosite pentru afișarea evenimentelor",
"eventColor_text" => "Evenimentele din calendar pot fi afișate folosind paletele definite de utilizator sau cele setate pentru categoria de eveniment.",
"owner_color" => "paletă utilizator",
"cat_color" => "paletă categorie",

//settings.php - date/time settings. Single quotes in the ......_text translations below must be escaped by a backslash (e.g. \')
"dateFormat_label" => "Formatul datei (zz ll aaaa)",
"dateFormat_text" => "Șir de caractere care definește modul de afișare pentru dată în calendar.<br>Caracterele acceptate: a = pentru an, l = pentru lună  și d = pentru zi.<br>Caracterele non-alfanumerice pot fi utilizate ca separator și vor fi copiate ca atare.<br>Exemplu:<br>a-l-z: 2012-10-31<br>l.z.a: 10.31.2012<br>z/l/a: 31/10/2012",
"dateFormat_expl" => "ex. a.l.z: 2012.10.31",
...
"MdyFormat_text" => "Șir de caractere care definește modul de afișare pentru dată în calendar, pentru zi, lună și an.<br>Caractere posibile: d = ziua în cifre, M = luna ca text, y = anul în cifre.<br>Caracterele non-alfanumerice pot fi utilizate ca separator și vor fi copiate ca atare.<br>Exemplu:<br>d M y: 12 Aprilie 2012<br>M d, y: Iulie 8, 2012",
"MdyFormat_expl" => "ex. L z, y: Iulie 8, 2012",
"MyFormat_label" => "Format dată (lună aaaa)",
"MyFormat_text" => "Șir de caractere care definește modul de afișare pentru dată în calendar, pentru lună și an.<br>Caractere posibile: L = luna ca text, y = anul în cifre.<br>Caracterele non-alfanumerice pot fi utilizate ca separator și vor fi copiate ca atare.<br>Exemplu:<br>L a: Aprilie 2012<br>a - L: 2012 - Iulie",
"MyFormat_expl" => "ex. L a: Aprilie 2012",
...
"log_pw_msg" => "Aveți aici parola pentru autentificare",
"log_pw_subject_pre" => "dvs.",
"log_pw_subject_post" => "Parola",
"log_npw_msg" => "Aveți aici noua parolă pentru autentificare",
"log_npw_subject_pre" => "Noua dumneavoastră",
"log_npw_subject_post" => "Parolă",
...
"log_date_time" => "Dată / oră",
"log_reload_retry" => "Eroare afișare. Închideți fereastra calendarului și reîncercați",
...
"usr_admin_functions" => "Funcții administrare",
...
"usr_post_manager" => "Postare/editare + aprobare evenimente",
...
"iex_select_birthday_delete" => "Selectați opțiunile Ziua de naștere și Ștergere după nevoie",
"iex_select_delete_ignore" => "Selectați opțiunea Ștergere pentru a ignora evenimentul",
"iex_title" => "Titlu",
"iex_venue" => "Locație",
...
"cro_mailer" => "server de email",
"cro_subject" => "Subiect",
"cro_event_due_in" => "Următorul eveniment este scadent la",
"cro_due_in" => "Scadent la",
"cro_days" => "zi(zile)",
...
"cro_status" => "Stare",
"cro_open_calendar" => "Deschide calendarul",
...
<p>Acest fișier de back-up permite refacerea bazei de date în cazul unui accident (pierderea bazei de date), folosind opțiunile de import ale  <strong>phpMyAdmin</strong> (acest pachet software, extrem de util, fiind preinstalat în majoritatea serverelor web actuale).</p>
<h5>Evenimente</h5>
...
<p>Opțional se poate adăuga și o descriere sumară a fișierului (ex. 'Activități 2012') care va apare în head-erul fișierului iCal exportat.</p>
