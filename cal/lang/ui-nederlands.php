...
Dit bestand is vertaald door de Purple Crocodile - opmerkingen en verbeteringen graag sturen naar rb@Issam.eu.
...
//header.php
"hdr_button_back" => "Terug naar de bovenliggende pagina",
...
"evt_status" => "Status",
"evt_descr_help" => "De volgende items kunnen in het veld \'omschrijving\' worden toegepast ...<br>- HTML tags &lt;b&gt;, &lt;i&gt;, &lt;u&gt; en &lt;s&gt; voor vette, schuine, onderstreepte en doorgehaalde tekst.<br>- Links naar websites in het volgende formaat: url of url [naam], waar \'naam\' de name van de link is. Bijv. www.google.nl [zoeken].<br>- Kleine images (thumbnails) in het volgende formaat: folder/image_naam.ext of image_naam.ext. Indien niet gespecificeerd, wordt de folder \'thumbnails\' verondersteld. De folder moet een subfolder van de kalender zijn en de extensie moet zijn .gif, .jpg of .png. Het thumbnail (image) bestand moet via FTP worden ge-upload.",
