...
"evt_status" => "Status",
"evt_descr_help" => "The following items can be included in the description field ...<br>- HTML tags &lt;b&gt;, &lt;i&gt;, &lt;u&gt; and &lt;s&gt; for bold, italic, underlined and striked-through text.<br>- länk till webbsida in the following format: url eller url [navn], where \'navn\' will be the title of the link. T.ex. www.google.se [sökning].<br>- small images (thumbnails) in the following format: folder/image_name.ext or image_name.ext. When omitted, the default folder is \'thumbnails\'. The folder must be a subfolder of the calendar and the extension must be .gif, .jpg or .png. The thumbnail (image) files should be uploaded via FTP.",
