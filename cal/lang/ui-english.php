...
$xx = array(
"set_event_student_name" => "Student Name",
"set_event_student_telephone" => "Student Telephone",
//general
"submit" => "Submit",
"none" => "None.",
"back" => "Back",
...
"sch_event_emp" => "Event employe",
"sch_event_circuit" => "Event circuit",
"sch_all_cats" => "All Categories",
"sch_all_emps" => "All Employes",
"sch_all_circuits" => "All Circuits",
"event_employe_name" => "Employee",
