...
"set_minical_settings" => "Mini Calendar (alleen relevant indien in gebruik)",
"set_sidebar_settings" => "Stand-Alone Sidebar<br>(alleen relevant indien in gebruik)",
...
"backLinkUrl_text" => "URL van de bovenliggende pagina. Indien gespecificeerd, zal er een Terug-knop worden weergegeven aan de linkerzijde van de Navigation Balk met een link naar de opgegeven URL.<br>Bijvoorbeeld om terug te linken naar de pagina waar vandaan de kalender werd gestart.",
...
"privEvents_label" => "Plaarsen van privé activiteiten",
"privEvents_text" => "Privé activiteiten zijn alleen zichtbaar voor de gebruiker die de activiteit invoerde.<br>Aan: gebruiker kan privé activiteiten invoeren.<br>Default: wanneer een nieuwe activiteit wordt toegevoegd, zal het \'privé\' vinkje in het Activiteit venster default aan staan..<br>Altijd: wanneer nieuwe activiteiten worden toegevoegd zullen deze altijd privézijn, de \'privé\' checkbox in het Activiteit venster zal niet zichtbaar zijn.",
"navButText_label" => "Navbar knoppen met tekst",
"navButText_text" => "Indien Aan: De knoppen op de navgatie balk zijn voorzien van tekst. Indien Uit: De knoppen worden weergegeven met een symbool.",
"navTodoList_label" => "Todo knop op navbar",
"navTodoList_text" => "Indien Aan: Een Todo knop zal worden weergegeven op de navigatie balk, welke wanneer geselecteerd de Todo lijst zal openen.",
"navUpcoList_label" => "Binnenkort knop op navbar",
"navUpcoList_text" => "Indien Aan: Een Binnenkort knop zal worden weergegeven op de navigatie balk, welke wanneer geselecteerd de Binnenkort lijst zal openen.",
...
"mailServer_text" => "PHP mail is bruikbaar voor niet beveiligde mail in kleine aantallen. Voor grotere aantallen te versturen e-mail of wanneer wachtwoord beveiliging vereist is, moet SMTP mail worden gebruikt.<br>Om SMTP mail te gebruiken is een SMTP mail server nodig. De configuration parameters voor de SMTP server moetten hierna worden gespecificeerd. Indien mail is uitgeschakeld, zal de Stuur mail sectie in het Activiteit window worden onderdrukt.",
"smtpServer_label" => "SMTP server naam",
"smtpServer_text" => "Indien SMTP mail is geselecteerd, moet hier de SMTP server naam woeder gespecificeerd. Bijvoorbeeld gmail SMTP server: smtp.gmail.com.",
"smtpPort_label" => "SMTP poort nummer",
"smtpPort_text" => "Indien SMTP mail is geselecteerd, moet hier het SMTP portnummer worden gespecificeerd. Bijvoorbeeld 25, 465 or 587. Gmail bijvoorbeeld, gebruikt poortnummer 465.",
"smtpSsl_label" => "SSL (Secure Sockets Layer)",
"smtpSsl_text" => "Indien SMTP mail is geselecteerd, kies dan hier of de secure sockets layer (SSL) moet worden gebruikt. Voor gmail: aan",
...
"smtpUser_text" => "Indien SMTP mail is geselecteerd, geef dan hier de SMTP gebruikersnaam. Voor gmail is dit het deel van het e-mail adres voor de @.",
"smtpPass_label" => "SMTP wachtwoord",
"smtpPass_text" => "Indien SMTP mail is geselecteerd, geef dan hier het SMTP wachtwoord.",
...
"chgEmailList_text" => "Mailadressen die periodiek een mail krijgen met wijzigingen in de kalender<br>Mail adressen gescheiden door puntkomma\'s.",
...
"monthInDCell_text" => "Display in maand weergave de 3-letterige maand naam for elke dag",
...
"usr_post_manager" => "Invoeren/wijzigen + manager rechten",
